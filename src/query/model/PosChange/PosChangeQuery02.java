 ...
 * @since 1.0
 */
public class PosChangeQuery02 implements Query {

	@Override
	public List<HashMap<String, String>> getResultList(String po_chg_rece_no, int arg1) {
	...
	public List<HashMap<String, String>> getResultList(String po_chg_rece_no) {
		...
		list = DBConnection.getResultList(DBConnection.executeQuery(st,
				"execute procedure cc137i('" + po_chg_rece_no + "')"));
